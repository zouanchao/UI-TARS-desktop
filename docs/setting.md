...
> [!NOTE]
> The returned URL should be persistent and publicly accessible without authentication.
...
**UTIO** (_UI-TARS Insights and Observation_) is a data collection mechanism for insights into UI-TARS Desktop. The design of UTIO is also related to sharing. The overall process is as follows:
